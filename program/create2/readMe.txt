...
This Arduino sketch demonstrates how to send data to **Firebase Realtime Database** using an **ESP8266** (NodeMCU or similar). It writes an integer values 1, 2, 3, 4... to the path `/value/number:number` every second.  
