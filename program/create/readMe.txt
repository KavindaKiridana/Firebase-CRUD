...
This Arduino sketch demonstrates how to send data to **Firebase Realtime Database** using an **ESP8266** (NodeMCU or similar). It writes an integer value (`123`) to the path `/test/value` every second.  
